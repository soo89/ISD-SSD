...
VOC_ROOT = "/ssd/Dataset/PASCALVOC/VOCdevkit/" #osp.join(HOME, "JISOO/data/VOCdevkit/")


class VOCCOCOAnnotationTransform(object):
...
class VOCCOCODetection_con(data.Dataset):
    ...
    def __init__(self, root,
                 image_sets=[('2007', 'trainval'), ('2012', 'trainval')],         #,('2014','COCO')], , ('2014', 'only_voc')
                 transform=None, target_transform=VOCCOCOAnnotationTransform(),
